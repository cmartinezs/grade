...
export const getStudentByEmailRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getStudentByEmail(dcOrVars, vars) {
...
export const getStudentCourseEvaluationByCourseEvaluationRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getStudentCourseEvaluationByCourseEvaluation(dcOrVars, vars) {
  return executeQuery(getStudentCourseEvaluationByCourseEvaluationRef(dcOrVars, vars));
}

export const getStudentCourseEvaluationRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getStudentCourseEvaluation(dcOrVars, vars) {
  return executeQuery(getStudentCourseEvaluationRef(dcOrVars, vars));
}

export const getStudentEvaluationQuestionsForEvaluationRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getStudentEvaluationQuestionsForEvaluation(dcOrVars, vars) {
  return executeQuery(getStudentEvaluationQuestionsForEvaluationRef(dcOrVars, vars));
}

export const getStudentEvaluationQuestionsWithDetailsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getStudentEvaluationQuestionsWithDetails(dcOrVars, vars) {
  return executeQuery(getStudentEvaluationQuestionsWithDetailsRef(dcOrVars, vars));
}

export const getEvaluationQuestionDetailsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getEvaluationQuestionDetails(dcOrVars, vars) {
  return executeQuery(getEvaluationQuestionDetailsRef(dcOrVars, vars));
}

export const getQuestionsDetailsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getQuestionsDetails(dcOrVars, vars) {
  return executeQuery(getQuestionsDetailsRef(dcOrVars, vars));
}

export const getQuestionTypesRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getQuestionTypes(dcOrVars, vars) {
  return executeQuery(getQuestionTypesRef(dcOrVars, vars));
}

export const getQuestionOptionsForQuestionsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getQuestionOptionsForQuestions(dcOrVars, vars) {
  return executeQuery(getQuestionOptionsForQuestionsRef(dcOrVars, vars));
}

export const getStudentAnswersForQuestionsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getStudentAnswersForQuestions(dcOrVars, vars) {
  return executeQuery(getStudentAnswersForQuestionsRef(dcOrVars, vars));
}

export const getCourseStudentsByStudentIdRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getCourseStudentsByStudentId(dcOrVars, vars) {
  return executeQuery(getCourseStudentsByStudentIdRef(dcOrVars, vars));
}

export const getStudentCourseEvaluationsByCourseStudentIdsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getStudentCourseEvaluationsByCourseStudentIds(dcOrVars, vars) {
  return executeQuery(getStudentCourseEvaluationsByCourseStudentIdsRef(dcOrVars, vars));
}

export const getCourseEvaluationsByIdsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getCourseEvaluationsByIds(dcOrVars, vars) {
  return executeQuery(getCourseEvaluationsByIdsRef(dcOrVars, vars));
}

export const getSubjectsByIdsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getSubjectsByIds(dcOrVars, vars) {
  return executeQuery(getSubjectsByIdsRef(dcOrVars, vars));
}

export const countStudentEvaluationQuestionsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function countStudentEvaluationQuestions(dcOrVars, vars) {
  return executeQuery(countStudentEvaluationQuestionsRef(dcOrVars, vars));
}

export const getCourseEvaluationFullDetailsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getCourseEvaluationFullDetails(dcOrVars, vars) {
  return executeQuery(getCourseEvaluationFullDetailsRef(dcOrVars, vars));
}

export const getStudentEnrollmentByEmailAndCourseRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getStudentEnrollmentByEmailAndCourse(dcOrVars, vars) {
