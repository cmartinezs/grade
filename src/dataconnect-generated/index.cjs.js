...
const updateCourseEvaluationAccessCodeRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.updateCourseEvaluationAccessCodeRef = updateCourseEvaluationAccessCodeRef;

exports.updateCourseEvaluationAccessCode = function updateCourseEvaluationAccessCode(dcOrVars, vars) {
...
const getStudentByEmailRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetStudentByEmail', inputVars);
}
getStudentByEmailRef.operationName = 'GetStudentByEmail';
exports.getStudentByEmailRef = getStudentByEmailRef;

exports.getStudentByEmail = function getStudentByEmail(dcOrVars, vars) {
  return executeQuery(getStudentByEmailRef(dcOrVars, vars));
};
...
const getCourseEvaluationByAccessCodeRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.getCourseEvaluationByAccessCodeRef = getCourseEvaluationByAccessCodeRef;

exports.getCourseEvaluationByAccessCode = function getCourseEvaluationByAccessCode(dcOrVars, vars) {
  return executeQuery(getCourseEvaluationByAccessCodeRef(dcOrVars, vars));
};

const getCourseEvaluationDetailsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.getCourseEvaluationDetailsRef = getCourseEvaluationDetailsRef;

exports.getCourseEvaluationDetails = function getCourseEvaluationDetails(dcOrVars, vars) {
  return executeQuery(getCourseEvaluationDetailsRef(dcOrVars, vars));
};

const validateStudentForEvaluationRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.validateStudentForEvaluationRef = validateStudentForEvaluationRef;

exports.validateStudentForEvaluation = function validateStudentForEvaluation(dcOrVars, vars) {
  return executeQuery(validateStudentForEvaluationRef(dcOrVars, vars));
};

const getStudentCourseEvaluationByCourseEvaluationRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetStudentCourseEvaluationByCourseEvaluation', inputVars);
}
getStudentCourseEvaluationByCourseEvaluationRef.operationName = 'GetStudentCourseEvaluationByCourseEvaluation';
exports.getStudentCourseEvaluationByCourseEvaluationRef = getStudentCourseEvaluationByCourseEvaluationRef;

exports.getStudentCourseEvaluationByCourseEvaluation = function getStudentCourseEvaluationByCourseEvaluation(dcOrVars, vars) {
  return executeQuery(getStudentCourseEvaluationByCourseEvaluationRef(dcOrVars, vars));
};

const getStudentCourseEvaluationRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetStudentCourseEvaluation', inputVars);
}
getStudentCourseEvaluationRef.operationName = 'GetStudentCourseEvaluation';
exports.getStudentCourseEvaluationRef = getStudentCourseEvaluationRef;

exports.getStudentCourseEvaluation = function getStudentCourseEvaluation(dcOrVars, vars) {
  return executeQuery(getStudentCourseEvaluationRef(dcOrVars, vars));
};

const getStudentEvaluationQuestionsForEvaluationRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetStudentEvaluationQuestionsForEvaluation', inputVars);
}
getStudentEvaluationQuestionsForEvaluationRef.operationName = 'GetStudentEvaluationQuestionsForEvaluation';
exports.getStudentEvaluationQuestionsForEvaluationRef = getStudentEvaluationQuestionsForEvaluationRef;

exports.getStudentEvaluationQuestionsForEvaluation = function getStudentEvaluationQuestionsForEvaluation(dcOrVars, vars) {
  return executeQuery(getStudentEvaluationQuestionsForEvaluationRef(dcOrVars, vars));
};

const getStudentEvaluationQuestionsWithDetailsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetStudentEvaluationQuestionsWithDetails', inputVars);
}
getStudentEvaluationQuestionsWithDetailsRef.operationName = 'GetStudentEvaluationQuestionsWithDetails';
exports.getStudentEvaluationQuestionsWithDetailsRef = getStudentEvaluationQuestionsWithDetailsRef;

exports.getStudentEvaluationQuestionsWithDetails = function getStudentEvaluationQuestionsWithDetails(dcOrVars, vars) {
  return executeQuery(getStudentEvaluationQuestionsWithDetailsRef(dcOrVars, vars));
};

const getEvaluationQuestionDetailsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetEvaluationQuestionDetails', inputVars);
}
getEvaluationQuestionDetailsRef.operationName = 'GetEvaluationQuestionDetails';
exports.getEvaluationQuestionDetailsRef = getEvaluationQuestionDetailsRef;

exports.getEvaluationQuestionDetails = function getEvaluationQuestionDetails(dcOrVars, vars) {
  return executeQuery(getEvaluationQuestionDetailsRef(dcOrVars, vars));
};

const getQuestionsDetailsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetQuestionsDetails', inputVars);
}
getQuestionsDetailsRef.operationName = 'GetQuestionsDetails';
exports.getQuestionsDetailsRef = getQuestionsDetailsRef;

exports.getQuestionsDetails = function getQuestionsDetails(dcOrVars, vars) {
  return executeQuery(getQuestionsDetailsRef(dcOrVars, vars));
};

const getQuestionTypesRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetQuestionTypes', inputVars);
}
getQuestionTypesRef.operationName = 'GetQuestionTypes';
exports.getQuestionTypesRef = getQuestionTypesRef;

exports.getQuestionTypes = function getQuestionTypes(dcOrVars, vars) {
  return executeQuery(getQuestionTypesRef(dcOrVars, vars));
};

const getQuestionOptionsForQuestionsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetQuestionOptionsForQuestions', inputVars);
}
getQuestionOptionsForQuestionsRef.operationName = 'GetQuestionOptionsForQuestions';
exports.getQuestionOptionsForQuestionsRef = getQuestionOptionsForQuestionsRef;

exports.getQuestionOptionsForQuestions = function getQuestionOptionsForQuestions(dcOrVars, vars) {
  return executeQuery(getQuestionOptionsForQuestionsRef(dcOrVars, vars));
};

const getStudentAnswersForQuestionsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetStudentAnswersForQuestions', inputVars);
}
getStudentAnswersForQuestionsRef.operationName = 'GetStudentAnswersForQuestions';
exports.getStudentAnswersForQuestionsRef = getStudentAnswersForQuestionsRef;

exports.getStudentAnswersForQuestions = function getStudentAnswersForQuestions(dcOrVars, vars) {
  return executeQuery(getStudentAnswersForQuestionsRef(dcOrVars, vars));
};

const getCourseStudentsByStudentIdRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetCourseStudentsByStudentId', inputVars);
}
getCourseStudentsByStudentIdRef.operationName = 'GetCourseStudentsByStudentId';
exports.getCourseStudentsByStudentIdRef = getCourseStudentsByStudentIdRef;

exports.getCourseStudentsByStudentId = function getCourseStudentsByStudentId(dcOrVars, vars) {
  return executeQuery(getCourseStudentsByStudentIdRef(dcOrVars, vars));
};

const getStudentCourseEvaluationsByCourseStudentIdsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetStudentCourseEvaluationsByCourseStudentIds', inputVars);
}
getStudentCourseEvaluationsByCourseStudentIdsRef.operationName = 'GetStudentCourseEvaluationsByCourseStudentIds';
exports.getStudentCourseEvaluationsByCourseStudentIdsRef = getStudentCourseEvaluationsByCourseStudentIdsRef;

exports.getStudentCourseEvaluationsByCourseStudentIds = function getStudentCourseEvaluationsByCourseStudentIds(dcOrVars, vars) {
  return executeQuery(getStudentCourseEvaluationsByCourseStudentIdsRef(dcOrVars, vars));
};

const getCourseEvaluationsByIdsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetCourseEvaluationsByIds', inputVars);
}
getCourseEvaluationsByIdsRef.operationName = 'GetCourseEvaluationsByIds';
exports.getCourseEvaluationsByIdsRef = getCourseEvaluationsByIdsRef;

exports.getCourseEvaluationsByIds = function getCourseEvaluationsByIds(dcOrVars, vars) {
  return executeQuery(getCourseEvaluationsByIdsRef(dcOrVars, vars));
};

const getSubjectsByIdsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetSubjectsByIds', inputVars);
}
getSubjectsByIdsRef.operationName = 'GetSubjectsByIds';
exports.getSubjectsByIdsRef = getSubjectsByIdsRef;

exports.getSubjectsByIds = function getSubjectsByIds(dcOrVars, vars) {
  return executeQuery(getSubjectsByIdsRef(dcOrVars, vars));
};

const countStudentEvaluationQuestionsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'CountStudentEvaluationQuestions', inputVars);
}
countStudentEvaluationQuestionsRef.operationName = 'CountStudentEvaluationQuestions';
exports.countStudentEvaluationQuestionsRef = countStudentEvaluationQuestionsRef;

exports.countStudentEvaluationQuestions = function countStudentEvaluationQuestions(dcOrVars, vars) {
  return executeQuery(countStudentEvaluationQuestionsRef(dcOrVars, vars));
};

const getCourseEvaluationFullDetailsRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetCourseEvaluationFullDetails', inputVars);
}
getCourseEvaluationFullDetailsRef.operationName = 'GetCourseEvaluationFullDetails';
exports.getCourseEvaluationFullDetailsRef = getCourseEvaluationFullDetailsRef;

exports.getCourseEvaluationFullDetails = function getCourseEvaluationFullDetails(dcOrVars, vars) {
  return executeQuery(getCourseEvaluationFullDetailsRef(dcOrVars, vars));
};

const getStudentEnrollmentByEmailAndCourseRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetStudentEnrollmentByEmailAndCourse', inputVars);
}
getStudentEnrollmentByEmailAndCourseRef.operationName = 'GetStudentEnrollmentByEmailAndCourse';
exports.getStudentEnrollmentByEmailAndCourseRef = getStudentEnrollmentByEmailAndCourseRef;

exports.getStudentEnrollmentByEmailAndCourse = function getStudentEnrollmentByEmailAndCourse(dcOrVars, vars) {
  return executeQuery(getStudentEnrollmentByEmailAndCourseRef(dcOrVars, vars));
};
