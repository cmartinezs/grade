...
**¿Busco información sobre el Sidebar?**
→ Ve a `docs/changes/01-sidebar-generic/README.md`

**¿Busco información sobre menús?**
→ Ve a `docs/changes/02-menu-alignment/README.md`

**¿Busco información sobre taxonomía?**
→ Ve a `docs/changes/00-taxonomy-refactor/README.md`
...
Estos archivos están archivados pero su contenido está **integrado en la documentación oficial** en:
- `docs/changes/01-sidebar-generic/README.md`
- `docs/changes/02-menu-alignment/README.md`

**No hay información perdida.** Toda la documentación importante está centralizada y organizada correctamente.
